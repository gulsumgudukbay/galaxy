        ...
        for input_index, input in enumerate(inputs.values()):
            ...
            if input.type == 'repeat':
                ...
                try:
                    ...
                    tool_dict['value'] = input.value_to_basic(state_inputs.get(input.name, initial_value), self.app)
                    tool_dict['default_value'] = input.value_to_basic(initial_value, self.app)
